...
namespace GameStore.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description")] OrderStatus orderStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description")] OrderStatus orderStatus)
        {
            if (ModelState.IsValid)
            {
